...
const EyeIconOpen = () => (
  <svg viewBox="0 0 24 24" width="20"><path fill="currentColor" d="M12 5c-4.5 0-8.4 2.6-10 7 1.6 4.4 5.5 7 10 7s8.4-2.6 10-7-1.6-4.4-5.5-7-10-7zm0 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10zm0-2.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/></svg>
);
const EyeIconClosed = () => (
